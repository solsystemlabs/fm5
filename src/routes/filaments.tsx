    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold text-gray-900 dark:text-white">Filaments</h1>
          <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
            A complete list of all your 3D printing filaments including their specifications and associated models.
          </p>
        </div>
      ...
      {isLoading ? (
        <div className="mt-8 p-8 text-center">
          <p className="text-gray-600 dark:text-gray-300">Loading filaments...</p>
        </div>
      ) : (
