            ...
            <Row key={filament.id}>
              ...
              >
                ...
                <div className="mt-1 flex flex-col text-gray-500 sm:block lg:hidden dark:text-gray-400">
                  <span>
                    {filament.brandName} / {filament.Material.name}
                  </span>
              ...
              <Cell
                className={classNames(
                  filamentIdx === 0 ? '' : 'border-t border-gray-200 dark:border-white/10',
              ...
              >
                <div className="text-gray-500 dark:text-gray-400">
                  {filament.Models && filament.Models.length > 0 ? (
                    <span>{filament.Models.length} model{filament.Models.length !== 1 ? 's' : ''}</span>
                  ) : (
                    <span>No models</span>
                  )}
                </div>
