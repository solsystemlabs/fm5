...
async function main() {
  ...
  await prisma.filamentType.createMany({
    data: [
      {
        name: "Basic",
        description: "Standard finish filament with smooth, glossy surface",
      },
      {
        name: "Sparkle",
        description:
          "Filament with metallic flakes that create a sparkling effect",
      },
      {
        name: "Metal",
        description:
          "Metal-filled filament with metallic appearance and weight",
      },
      {
        name: "Matte",
        description: "Low-gloss filament with a smooth, non-reflective finish",
      },
    ],
    skipDuplicates: true,
  });
  ...
  await prisma.model.createMany({
    data: [
      {
        name: "Ancient Dragon",
        modelCategoryId: categories.find((c) => c.name === "Miniatures")!.id,
      },
      {
        name: "Medieval Castle",
        modelCategoryId: categories.find((c) => c.name === "Terrain")!.id,
      },
      {
        name: "Battle Tank",
        modelCategoryId: categories.find((c) => c.name === "Vehicles")!.id,
      },
      {
        name: "Wizard Staff",
        modelCategoryId: categories.find((c) => c.name === "Accessories")!.id,
      },
      {
        name: "Skull Keychain",
        modelCategoryId: categories.find((c) => c.name === "Keychains")!.id,
      },
      {
        name: "Celtic Knot Earrings",
        modelCategoryId: categories.find((c) => c.name === "Earrings")!.id,
      },
      {
        name: "Dragon Pendant",
        modelCategoryId: categories.find((c) => c.name === "Necklaces")!.id,
      },
      {
        name: "Modular Terrain Set",
        modelCategoryId: categories.find((c) => c.name === "Terrain")!.id,
      },
      {
        name: "Phone Stand",
        modelCategoryId: categories.find((c) => c.name === "Tools")!.id,
      },
      {
        name: "Dice Tower",
        modelCategoryId: categories.find((c) => c.name === "Accessories")!.id,
      },
      {
        ...
        modelCategoryId: categories.find((c) => c.name === "Household")!.id,
      },
      {
        name: "Sports Car",
        modelCategoryId: categories.find((c) => c.name === "Vehicles")!.id,
  ...
  const productData = [
    ...
    {
      name: "Gold Metal Dragon",
      model: "Ancient Dragon",
      price: 35.99,
      filamentsCount: 1,
    },
    {
      name: "Medieval Castle - Stone",
      model: "Medieval Castle",
      price: 28.5,
      filamentsCount: 2,
    },
    {
      name: "Medieval Castle - Dark",
      model: "Medieval Castle",
      price: 29.99,
      filamentsCount: 2,
    },
    {
      name: "Military Tank - Camo",
      model: "Battle Tank",
      price: 22.99,
      filamentsCount: 2,
    },
    {
      name: "Battle Tank - Steel",
      model: "Battle Tank",
      price: 24.99,
      filamentsCount: 1,
    },
    {
      name: "Wizard Staff - Mystic",
      model: "Wizard Staff",
      price: 18.99,
      filamentsCount: 2,
    },
    {
      name: "Skull Keychain - Black",
      model: "Skull Keychain",
      price: 6.99,
      filamentsCount: 1,
    },
    {
      name: "Skull Keychain - Red",
      model: "Skull Keychain",
      price: 7.99,
      filamentsCount: 1,
    },
    {
      name: "Skull Keychain - Glow",
      model: "Skull Keychain",
      price: 8.99,
      filamentsCount: 1,
    },
    {
      name: "Celtic Earrings - Silver",
      model: "Celtic Knot Earrings",
      price: 12.99,
      filamentsCount: 1,
    },
    {
      name: "Celtic Earrings - Gold",
      model: "Celtic Knot Earrings",
      price: 13.99,
      filamentsCount: 1,
    },
    {
      name: "Dragon Pendant - Purple",
      model: "Dragon Pendant",
      price: 15.99,
      filamentsCount: 1,
    },
    {
      name: "Dragon Pendant - Copper",
      model: "Dragon Pendant",
      price: 17.99,
      filamentsCount: 1,
    },
    {
      name: "Modular Terrain - Forest",
      model: "Modular Terrain Set",
      price: 25.99,
      filamentsCount: 3,
    },
    {
      name: "Modular Terrain - Desert",
      model: "Modular Terrain Set",
      price: 24.99,
      filamentsCount: 2,
    },
    ...
    {
      name: "Phone Stand - White",
      model: "Phone Stand",
      price: 10.99,
      filamentsCount: 1,
    },
    {
      name: "Phone Stand - Wood",
      model: "Phone Stand",
      price: 14.99,
      filamentsCount: 1,
    },
    {
      name: "Dice Tower - Classic",
      model: "Dice Tower",
      price: 19.99,
      filamentsCount: 2,
    },
    {
      name: "Dice Tower - Sparkle",
      model: "Dice Tower",
      price: 22.99,
      filamentsCount: 1,
    },
    {
      name: "Utensil Holder - Modern",
      model: "Kitchen Utensil Holder",
      price: 16.99,
      filamentsCount: 1,
    },
    {
      name: "Utensil Holder - Rustic",
      model: "Kitchen Utensil Holder",
      price: 18.99,
      filamentsCount: 1,
    },
    ...
    {
      name: "Sports Car - Classic",
      model: "Sports Car",
      price: 20.99,
      filamentsCount: 1,
    },
    {
      name: "Elf Warrior - Battle",
      model: "Elf Warrior",
      price: 26.99,
      filamentsCount: 2,
    },
    {
      name: "Elf Warrior - Noble",
      model: "Elf Warrior",
      price: 28.99,
      filamentsCount: 3,
    },
    {
      name: "Geometric Earrings - Rose Gold",
      model: "Geometric Earrings",
      price: 9.99,
      filamentsCount: 1,
    },
    {
      name: "Geometric Earrings - Silver",
      model: "Geometric Earrings",
      price: 8.99,
      filamentsCount: 1,
    },
    {
      name: "Geometric Earrings - Multi",
      model: "Geometric Earrings",
      price: 11.99,
      filamentsCount: 2,
    },
  ...
  for (let i = 0; i < productData.length; i++) {
    ...
    const threeMFFile = createdThreeMFFiles.find(
      (tmf) => tmf.modelId === model.id,
    )!;
    ...
    for (let j = 0; j < product.filamentsCount; j++) {
      const availableFilaments = filaments.filter(
        (f) => !selectedFilaments.includes(f),
      );
      const randomFilament =
        availableFilaments[
          Math.floor(Math.random() * availableFilaments.length)
        ];
    ...
    for (let j = 0; j < selectedFilaments.length; j++) {
      ...
      const totalWeight =
        slicedFile.totalFilamentWeight! / selectedFilaments.length; // Distribute weight across filaments
      const totalLength =
        slicedFile.totalFilamentLength! / selectedFilaments.length;
      const totalVolume =
        slicedFile.totalFilamentVolume! / selectedFilaments.length;
      ...
      await prisma.slicedFileFilament.create({
        data: {
          ...
          filamentType:
            materials.find((m) => m.id === filament.materialTypeId)?.name ||
            "PLA",
